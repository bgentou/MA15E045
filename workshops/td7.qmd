...
[Postgresql documentation on range types](https://www.postgresql.org/docs/current/rangetypes.html){target="_blank"}
...
{{< fa hand-point-right >}} Nous sommes dans une situation où une colonne peut être calculée à partir d'autres colonnes. PostgreSQL propose des [genrated columns](https://www.postgresql.org/docs/current/ddl-generated-columns.html){target="_blank"} pour traîter ce genre de situations. 
