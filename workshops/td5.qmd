...
[Documentation](https://www.postgresql.org/docs/15/xfunc-sql.html){target="_blank"}
...
Les données sont construites et mises à disposition par l'INSEE [https://www.insee.fr/fr/accueil](https://www.insee.fr/fr/accueil){target="_blank"}, disponibles  ici: [https://www.insee.fr/fr/statistiques/fichier/2540004/nat2021_csv.zip](https://www.insee.fr/fr/statistiques/fichier/2540004/nat2021_csv.zip){target="_blank"}
...
[https://www.seuil.com/ouvrage/l-archipel-francais-jerome-fourquet/9782021406023](https://www.seuil.com/ouvrage/l-archipel-francais-jerome-fourquet/9782021406023){target="_blank"}.
...
```{.sql}
CREATE OR REPLACE FUNCTION babynames.fonc_td5_1(p_prenom TEXT) 
...
```
::: {.callout-caution}
Remplacer `babynames.fonc_td5_1`  par `username.fonc_td5_1`.
:::
...
```{.sql}
CREATE OR REPLACE FUNCTION babynames.fonc_td5_2(p_annee int4)
...
[https://www.postgresql.org/docs/15/sql-expressions.html#SYNTAX-WINDOW-FUNCTIONS](https://www.postgresql.org/docs/15/sql-expressions.html#SYNTAX-WINDOW-FUNCTIONS){target="_blank"}
