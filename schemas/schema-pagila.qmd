...
- [Page maison de la base de données  `pagila`](https://github.com/devrimgunduz/pagila). 
- [Page maison de la base de données  `sakila`](https://dev.mysql.com/doc/sakila/en/)
