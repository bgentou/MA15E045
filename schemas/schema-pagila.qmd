...
![Schema pagila créé par [DbSchema](https://dbschema.com)](/images/avt-2025/schemas/schema-pagila.png)
...
- [Page maison de la base de données  `pagila`](https://github.com/devrimgunduz/pagila){target="_blank"}. 
- [Page maison de la base de données  `sakila`](https://dev.mysql.com/doc/sakila/en/){target="_blank"}
- [Détails sur les films](/schemas/schema-pagila-film.qmd){target="_blank"}
- [Détails sur les adresses, clients, magasins, paiements](/schemas/schema-pagila-address.qmd){target="_blank"}
...
Notons ici qu'une entrée de la table `film` ne correspond pas tout à fait à l'idée que nous nous faisons d'un film (entrée dans la base [IMDB](https://www.imdb.com){target="_blank"}), mais plutôt à une édition (simplifiée) de film en DVD.
