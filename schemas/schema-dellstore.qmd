...
![Schema dellstore créé par [DbSchema](https://dbschema.com)](/images/avt-2025/schemas/schema-dellstore.png)
...
Les sources du schéma sont décrites  [sur le site de Dell](https://linux.dell.com/dvdstore/readme.txt){target="_blank"} 
