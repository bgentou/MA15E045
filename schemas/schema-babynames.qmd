...
![Schema `babynames` Generated using [DbSchema](https://dbschema.com)](/images/avt-2025/schemas/schema-babynames.png)


Ce jeu de données est fourni par l'INSEE [https://www.insee.fr/fr/statistiques/fichier/2540004/nat2021_csv.zip](https://www.insee.fr/fr/statistiques/fichier/2540004/nat2021_csv.zip){target="_blank"} permet d'étudier l'évolution des prénoms donnés en France entre 1900 et aujourd'hui.
