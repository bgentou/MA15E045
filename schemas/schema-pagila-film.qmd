...
![Schema pagila créé par [DbSchema](https://dbschema.com)](/images/avt-2025/schemas/schema-pagila-film.png)
...
[Pagemaison de la base de données  `pagila`](https://github.com/devrimgunduz/pagila){target="_blank"}. 

[Pagemaison de la base de données  `sakila`](https://dev.mysql.com/doc/sakila/en/){target="_blank"}
