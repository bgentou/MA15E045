...
-   [Recording presentations in Zoom](https://kb.siue.edu/61721){target="_blank"}
-   [Apple Quicktime for screen recording](https://support.apple.com/en-gb/guide/quicktime-player/qtp97b08e666/mac){target="_blank"}
-   [Windows 10 built-in screen recording functionality](https://www.youtube.com/watch?v=OfPbr1mRDuo){target="_blank"}
-   [Kap for screen recording](https://getkap.co/){target="_blank"}
