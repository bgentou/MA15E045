...
Le mécanisme du tunnel `ssh` peut être utilisé pour connecter un client plus ambitieux au serveur. Le client [`dbeaver`](https://dbeaver.io) est particulièrement facile à utiliser. Voir la page [Client `dBeaver`](/computing-dbeaver.qmd) pour son utilisation.
