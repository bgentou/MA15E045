...
À partir de [Dbeaver community edition](https://dbeaver.io/download/){target="_blank"}

## Paramétrage pour éviter l'erreur `too many connections`
...
{{< fa brands youtube >}} [Explorer les possibilités du client dBeaver](https://www.youtube.com/watch?v=qWhCmvg_Sqc){target="_blank"}
...
[documentation sur les signets](https://github.com/dbeaver/dbeaver/wiki/Bookmarks){target="_blank"}.
...
# Editeur SQL
::: {.callout-tip}
[Documentation éditeur SQL dBeaver](https://dbeaver.com/docs/dbeaver/SQL-Editor/){target="_blank"}
:::
...
- [Documentation dBeaver](https://dbeaver.com/docs/dbeaver/Application-Window-Overview/){target="_blank"}
- [wiki](https://github.com/dbeaver/dbeaver/wiki){target="_blank"}
