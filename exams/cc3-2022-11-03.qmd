...
Les questions portent sur le schéma `nycflights13` issu de [https://github.com/tidyverse/nycflights13](https://github.com/tidyverse/nycflights13){target="_blank"}.

Voir [Documentation package R nycflights13](https://nycflights13.tidyverse.org){target="_blank"}
...
qui recense pour chaque semaine (commencant le dimanche) les avions (identifiés par `tailnum`) qui ont parcouru la plus grande distance durant cette semaine, la distance parcourue pendant la semaine (en [milles nautiques](https://fr.wikipedia.org/wiki/Mille_marin){target="_blank"}), on indiquera aussi le modèle (`model`) de l'avion
...
- [Doc PostgreSQL : types](https://www.postgresql.org/docs/current/datatype-datetime.html){target="_blank"}
- [Doc PostgreSQL : fonctions](https://www.postgresql.org/docs/current/functions-datetime.html){target="_blank"}
