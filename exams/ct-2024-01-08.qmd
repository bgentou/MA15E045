...
![NYCFlights en relationel à pattes de corbeau](./avt-2025/schemas/nycflights_layout_crop.png){width="80%"}

{{< pagebreak >}}



{{< include ./avt-2025/schemas/_nycflights_bis_sql_ddl.qmd >}}
...
![](./avt-2025/schemas/nycflight_er.png){width="70%" fig-align="right"}
