...
## Situation du cours Bases de Données (MA15E045) dans la [Licence MIASHS](https://licence.math.u-paris.fr/formations/miashs/){target="_blank"}
...
https://doi.org/10.1017/CBO9780511818851){target="_blank"}
 
{{< fa brands slideshare >}} [Relational databses on slideshare](https://www.slideshare.net/search?searchfrom=header&q=relational+databases){target="_blank"}
...
- [ORACLE (commercial)](https://www.oracle.com){target="_blank"}

- [DB2 (IBM commercial)](https://www.ibm.com/db2){target="_blank"}

- [SQLSERVER (Microsoft commercial)](https://www.microsoft.com/fr-fr/sql-server/sql-server-2022){target="_blank"}

- [MySQL (open source)](https://www.mysql.com){target="_blank"}

- [**PostGres** (open source)](https://www.postgresql.org){target="_blank"}

- [Hana (commercial)](https://www.sap.com/france/products/technology-platform/hana/what-is-sap-hana.html){target="_blank"}
...
- [`psql`](https://www.postgresql.org/docs/current/app-psql.html){target="_blank"}

- [`pgcli`](https://www.pgcli.com){target="_blank"}
...
![Image World](/images/modelisation/MRD_world2.svg)
...
["Entrepôt de données" sur Wikipedia](https://fr.wikipedia.org/wiki/Entrepôt_de_données){target="_blank"}
...
[NoSQL](https://fr.wikipedia.org/wiki/NoSQL){target="_blank"}
...
[Guy Harrison. Next Generation Databases. NoSQL, NewSQL, Big Data](http://guyharrison.squarespace.com/blog/tag/nosql){target="_blank"}
