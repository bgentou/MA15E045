...
[Sélection bien tempérée](https://dplyr.tidyverse.org/reference/dplyr_tidy_select.html){target="_blank"}
...
[`dplyr` sur le groupement](https://dplyr.tidyverse.org/articles/grouping.html){target="_blank"}
...
- [Page maison `dplyr`](https://dplyr.tidyverse.org/){target="_blank"}
- []()
