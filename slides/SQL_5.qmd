...
Voir [Documentation officielle](https://www.postgresql.org/docs/current/plpgsql.html){target="_blank"}
...
Voir [Documentation officielle](https://www.postgresql.org/docs/current/plpgsql-declarations.html){target="_blank"}
