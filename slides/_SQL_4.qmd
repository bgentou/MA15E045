...
[https://www.postgresql.org/docs/15/xfunc-sql.html](https://www.postgresql.org/docs/15/xfunc-sql.html){target="_blank"}
...
![](/images/avt-2025/schemas/pagila_full.png)
...
[Stackoverflow](https://stackoverflow.com/questions/2560946/postgresql-group-concat-equivalent){target="_blank"}
...
- [Postgresql Bloggers](https://planet.postgresql.org){target="_blank"}
